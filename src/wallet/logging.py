...
def add_app_distribution(
    dist: Distribution,
) -> Callable[[BoundLogger, str, EventDict], EventDict]:
    """Add application name to log."""

    def processor(logger: BoundLogger, name: str, event_dict: EventDict) -> EventDict:
...
def add_hostname() -> Callable[[BoundLogger, str, EventDict], EventDict]:
    """Add hostname to log."""
...
def remove_extra(logger: BoundLogger, name: str, event_dict: EventDict) -> EventDict:
...
def configure_logging(dist: Distribution, debug: bool = False) -> BoundLogger:
    ...
    return cast(BoundLogger, structlog.get_logger(dist.name))
